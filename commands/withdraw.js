...
module.exports = {
    ...
    usage: `${pfix.all()[0].data[0]}withdraw <kwota/all>`,
    permission: ["NULL"],
    type: "economy",
    run: async (message, args) =>{
        ...
        if(args[0] === 'all'){
            ...
            return message.channel.send("```Wypłacono: "+bank+pfix.all()[1].data[0]+"```");
            ...
            return message.channel.send("```Wypłacono: "+parseInt(args[0])+pfix.all()[1].data[0]+"```");
        };
    },
};